---
title: "CLAUDE.md Template: Minimum Viable Project Rules"
description: "Use a CLAUDE.md template to compress repeated mistakes from a completed task into short, specific, verifiable project rules."
sidebar:
  order: 2
difficulty: beginner
